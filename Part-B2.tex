...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{DRAM in a nutshell}, rightrule=.15mm, left=2mm, breakable, bottomtitle=1mm, titlerule=0mm, coltitle=black, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame]
...
\leavevmode\vadjust pre{\hypertarget{ref-Greer2021}{}}%
\CSLLeftMargin{106. }%
