...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6, toptitle=1mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{DRAM in a nutshell}, toprule=.15mm, rightrule=.15mm, opacityback=0, titlerule=0mm, breakable, left=2mm]
